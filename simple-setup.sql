-- Simple Database Setup for CalmKaaj
...
-- Insert admin user with simple password hash (admin123)
...
WHERE o.email = 'admin@calmkaaj.com'
ON CONFLICT (email) DO NOTHING;

-- Insert menu categories
INSERT INTO menu_categories (name, description, display_order) VALUES
('Coffee & Tea', 'Hot and cold beverages', 1),
('Snacks', 'Light snacks and treats', 2),
('Lunch', 'Main course meals', 3)
ON CONFLICT DO NOTHING;
...
INSERT INTO meeting_rooms (name, description, capacity, hourly_rate) VALUES
('Conference Room A', 'Large conference room with projector', 20, 50.00),
('Meeting Room B', 'Medium meeting room', 8, 30.00),
('Huddle Space', 'Small meeting space', 4, 20.00)
ON CONFLICT DO NOTHING;
...
SELECT 
  'Welcome to CalmKaaj!',
  'Welcome to our new coworking space. We hope you enjoy your time here!',
  u.id,
  1
FROM users u
WHERE u.email = 'admin@calmkaaj.com'
ON CONFLICT DO NOTHING; 