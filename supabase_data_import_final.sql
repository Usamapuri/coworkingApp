-- Final Data Import for Supabase
-- This file clears existing data first, then imports all data

-- Clear existing data (in reverse order of dependencies)
DELETE FROM public.cafe_order_items;
DELETE FROM public.cafe_orders;
DELETE FROM public.meeting_bookings;
...
ALTER SEQUENCE public.cafe_order_items_id_seq RESTART WITH 1;
ALTER SEQUENCE public.cafe_orders_id_seq RESTART WITH 1;
ALTER SEQUENCE public.meeting_bookings_id_seq RESTART WITH 1;
ALTER SEQUENCE public.meeting_rooms_id_seq RESTART WITH 1;
ALTER SEQUENCE public.menu_categories_id_seq RESTART WITH 1;
...
(6, 'Lays Slated', 'Chips that are nice', 200.00, 2, true, 'blue_area', '2025-07-05 21:29:59.090594'),
(7, 'LATTE', 'FEAFEW', 55000.00, 1, true, 'blue_area', '2025-07-07 12:53:31.35627'),
...
(28, 'DeezNuts', 'Fresh nuts', 60.00, 2, true, 'blue_area', '2025-07-10 07:47:22.311637'),
(29, 'waffles', '', 700.00, 3, true, 'blue_area', '2025-07-16 11:06:16.602924');
